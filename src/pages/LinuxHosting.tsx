  ...
  const plans = [
    {
      ...
      description: "Reliable hosting with essential features and 24/7 support.",
    ...
    },
    {
      ...
      description: "Perfect for growing websites with extra resources.",
    ...
    },
    {
      ...
      description: "Premium hosting with maximum performance and support.",
